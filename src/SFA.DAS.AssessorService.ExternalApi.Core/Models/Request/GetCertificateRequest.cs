namespace SFA.DAS.AssessorService.ExternalApi.Core.Models.Request
{
    ...
    public sealed class GetCertificateRequest : IEquatable<GetCertificateRequest>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return IsEqual((GetCertificateRequest)obj);
        }
        ...
        private bool IsEqual(GetCertificateRequest other)
        {
        ...
        public static bool operator ==(GetCertificateRequest left, GetCertificateRequest right)
        {
