namespace SFA.DAS.AssessorService.ExternalApi.Core.Messages.Request.Epa
{
    ...
    public sealed class CreateEpaRequest : IEquatable<CreateEpaRequest>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return IsEqual((CreateEpaRequest)obj);
        }

        public bool Equals(CreateEpaRequest other)
        {
        ...
        private bool IsEqual(CreateEpaRequest other)
        {
        ...
        public static bool operator ==(CreateEpaRequest left, CreateEpaRequest right)
        {
