namespace SFA.DAS.AssessorService.ExternalApi.Core.Messages.Request.Learners
{
    using System;
    using System.Collections.Generic;
    using System.ComponentModel.DataAnnotations;

    public sealed class GetLearnerRequest : IEquatable<GetLearnerRequest>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return IsEqual((GetLearnerRequest)obj);
        }

        public bool Equals(GetLearnerRequest other)
        {
        ...
        private bool IsEqual(GetLearnerRequest other)
        {
        ...
        public static bool operator ==(GetLearnerRequest left, GetLearnerRequest right)
        {
