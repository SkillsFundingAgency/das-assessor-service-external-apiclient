namespace SFA.DAS.AssessorService.ExternalApi.Client.ViewModels
{
    ...
    public class CreateViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<CreateCertificateRequest> Certificates { get; private set; }
        ...
        {
            Certificates = new ObservableCollection<CreateCertificateRequest>();
        ...
        {
            CreateCertificateRequest certificate = e.Item as CreateCertificateRequest;
