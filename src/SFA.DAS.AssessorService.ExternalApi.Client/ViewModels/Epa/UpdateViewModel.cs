namespace SFA.DAS.AssessorService.ExternalApi.Client.ViewModels.Epa
{
    ...
    public class UpdateViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<UpdateEpaRequest> Requests { get; private set; }
        ...
        {
            Requests = new ObservableCollection<UpdateEpaRequest>();
        ...
        {
            var request = e.Item as UpdateEpaRequest;
