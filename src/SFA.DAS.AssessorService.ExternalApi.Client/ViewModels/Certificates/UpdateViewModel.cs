namespace SFA.DAS.AssessorService.ExternalApi.Client.ViewModels.Certificates
{
    ...
    public class UpdateViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<UpdateCertificateRequest> Requests { get; private set; }
        ...
        {
            Requests = new ObservableCollection<UpdateCertificateRequest>();
        ...
        {
            var request = e.Item as UpdateCertificateRequest;
