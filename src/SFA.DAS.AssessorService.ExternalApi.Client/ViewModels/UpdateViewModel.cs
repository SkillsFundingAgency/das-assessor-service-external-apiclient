namespace SFA.DAS.AssessorService.ExternalApi.Client.ViewModels
{
    ...
    public class UpdateViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<UpdateCertificateRequest> Certificates { get; private set; }
        ...
        {
            Certificates = new ObservableCollection<UpdateCertificateRequest>();
        ...
        {
            UpdateCertificateRequest certificate = e.Item as UpdateCertificateRequest;
