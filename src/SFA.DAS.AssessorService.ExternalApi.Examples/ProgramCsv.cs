namespace SFA.DAS.AssessorService.ExternalApi.Examples
{
    ...
    public class ProgramCsv
    {
        public static void Main()
        {
            ...
            // NOTE: On the 1st of every month the Sandbox Environment will be refreshed with a test data set based on 
            // the current Register of End Point Assessor Organisations.

            // NOTE: The example values in the .csv files are not guaranteed to complete successfully, they 
            // may work in a refreshed sandbox as the CertificateReference numbers used are generated by creating
            // certificates but the examples given are those of the first certificates which would be created 
            // in a refreshed sandbox and would have to have been created for the correct Uln and StandardCode
            // before any other certificates were created. 
